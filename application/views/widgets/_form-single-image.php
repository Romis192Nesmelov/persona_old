...
?>
<form class="w-1 img-uploader js-single-uploader" autocomplete="off" data-delete="/dashboard/deleteImage">
    ...
    <?php if (isset($params['allow_delete'])) : ?>
    ...
    <div class="row w-1">
        <div class="input-group file <?php echo $disabled ? 'disabled' : ''; ?>">
            ...
            <input id="<?php echo $params['name']; ?>" <?= $disabled ? 'disabled' : ''; ?> type="file" name="upload[]" class="<?php echo $disabled ? 'disabled' : ''; ?>"
        ...
        <div class="img" <?= isset($tooltip) && $tooltip ? 'data-tooltip="' . $params['name'] . '.' . $params['ext'] . '"' : '' ?>>
