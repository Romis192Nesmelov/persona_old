<?php if (isset($salon) && isset($salons) && isset($utm)) : ?>
            ...
            <div class="container">
                ...
                <ul class="header__nav-links">
                    <li class="header__nav-link">
                        <a target="_blank" href="/#Services"><span>Услуги</span></a>
                    </li>
                    <li class="header__nav-link">
                        <a target="_blank" href="/#Salons"><span>Салоны</span></a>
                    </li>
                    <li class="header__nav-link">
                        <a target="_blank" href="/#Offers"><span>Акции</span></a>
                    </li>

                    <li class="header__nav-link">
                        <a target="_blank" href="/#About"><span>О нас</span></a>
                    </li>
    ...
    <amp-sidebar id="mobile-menu" layout="nodisplay" side="right">
        <nav class="sidebar">
            ...
            <a target="_blank" href="/#Services" on="tap:Services.scrollTo" class="sidebar__link">Услуги</a>
            <a target="_blank" href="/#Salons" on="tap:Salons.scrollTo" class="sidebar__link">Салоны</a>
            <a target="_blank" href="/#Offers" on="tap:Offers.scrollTo" class="sidebar__link">Акции</a>
            <a target="_blank" href="/#About" on="tap:About.scrollTo" class="sidebar__link">О нас</a>
