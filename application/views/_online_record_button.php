<a class="info-link yellow" target="_blank" tabindex="0" <?= !$useDropDown && isset($salon) ? 'href="'.$salon['online_link'].'&utm_source='.$utm.'"' : '' ?> rel="nofollow">
...
<?php if ($useDropDown && isset($salon) && $salon['slug'] == 'default') : ?>
