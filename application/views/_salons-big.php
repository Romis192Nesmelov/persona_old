        ...
        <div>
            <div class="grd">
                <?php foreach ($salons as $salon) : ?>
                    <a id="<?= $salon['slug'] ?>" class="w-1 item" href="<?php echo base_url() . $salon['slug']; ?>">
                        <p class="bot-mrgn-sml">
                            <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 772 529.93" class="metro" fill="<?php echo $salon['metro_color']; ?>">
                        ...
                        <p class="bot-mrgn-sml"><?php echo $salon['address_short']; ?></p>
                        <p class="sml bot-mrgn-ult"><?php echo $salon['tel']; ?></p>
