        ...
        <div>
            ...
            <div class="info">
                <div class="call__container">
                    <a <?php if ($salon['slug'] != 'default') : ?>href="tel:<?= $salon['tel'] ?>"<?php endif; ?> class="info-link" tabindex="0">
                        <svg class="icon" width="20" height="20" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="booking__container">
                    ...
                    padding: 4px 12px;
                    border-radius: 16px;" tabindex="0" <?= $salon['slug'] != 'default' ? 'class="info-link" href="' . $salon['online_link'] . '&utm_source=promo_' . $utm .  '"' : 'class="info-link"'?>>
                        <!-- TODO: add booking__popup-open class to link with online_link -->
                        <!-- TODO: remove popup-trigger of link with online_link -->
                        <svg style="fill: #000000" class="icon" width="20" height="20" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <?php if ($salon['slug'] == 'default') : ?>
                        <div class="booking__links-container">
                            <div class="booking__links">
                                ...
                                <?php foreach ($salons as $salon_book) : ?>
                                    <a popup-trigger="about-lead" href="<?= $salon_book['online_link'] . "&utm_source=promo_$utm" ?>" target="_blank" class="booking__links-item" rel="nofollow">Персона <?= $salon_book['name'] ?></a>
                                <?php endforeach; ?>
                                <!-- TODO: add booking__popup-open class to link with online_link -->
                                <!-- TODO: remove popup-trigger of link with online_link -->
                            </div>
                ...
                <div class="instagram__container">
                    <a <?php if ($salon['slug'] != 'default') : ?>href="<?= $salon['instagram'] ?>"<?php endif; ?> target="_blank" class="info-link" tabindex="0">
                        ...
                        <div class="instagram__links-container">
                            <div class="instagram__links">
                                ...
                                <?php foreach ($salons as $salon_inst) : ?>
                                    <a href="<?= $salon_inst['instagram'] ?>" target="_blank" class="instagram__links-item">@персона <?= $salon_inst['name'] ?></a>
                                <?php endforeach; ?>
                            </div>
                        </div>
                    <?php endif ?>
